 ...
 */
class TrainRecyclerViewAdapter(
    private val values: List<TrainDisputesContent.DisputesItem>/*, var mContext: Context*/
) : RecyclerView.Adapter<TrainRecyclerViewAdapter.ViewHolder>() {
    ...
    class ViewHolder(view: View, var item: TrainDisputesContent.DisputesItem? = null): RecyclerView.ViewHolder(view) {
