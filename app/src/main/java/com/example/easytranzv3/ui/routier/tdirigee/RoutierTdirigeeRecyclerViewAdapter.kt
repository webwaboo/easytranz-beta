 ...
 */
class RoutierTdirigeeRecyclerViewAdapter(
    private val values: List<RoutierTdirigeeDisputesContent.DisputesItem>/*, var mContext: Context*/
) : RecyclerView.Adapter<RoutierTdirigeeRecyclerViewAdapter.ViewHolder>() {
    ...
    class ViewHolder(view: View, var item: RoutierTdirigeeDisputesContent.DisputesItem? = null): RecyclerView.ViewHolder(view) {
