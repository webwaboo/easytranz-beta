package com.example.easytranzv3.ui.fluvial.national
 ...
 */
class FluvialRecyclerViewAdapter(
    private val values: List<FluvialDisputesContent.DisputesItem>/*, var mContext: Context*/
) : RecyclerView.Adapter<FluvialRecyclerViewAdapter.ViewHolder>() {
    ...
    class ViewHolder(view: View, var item: FluvialDisputesContent.DisputesItem? = null): RecyclerView.ViewHolder(view) {
