package com.example.easytranzv3.ui.routier.vroulant
 ...
 */
class RoutierVroulantRecyclerViewAdapter(
    private val values: List<RoutierVroulantDisputesContent.DisputesItem>/*, var mContext: Context*/
) : RecyclerView.Adapter<RoutierVroulantRecyclerViewAdapter.ViewHolder>() {
    ...
    class ViewHolder(view: View, var item: RoutierVroulantDisputesContent.DisputesItem? = null): RecyclerView.ViewHolder(view) {
