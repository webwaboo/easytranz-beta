 ...
 */
class RoutierCMRListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                adapter = RoutierCMRRecyclerViewAdapter(RoutierCMRDisputesContent.DISPUTES)
            }

            (activity as AppCompatActivity).supportActionBar?.title = "CMR"
        }
