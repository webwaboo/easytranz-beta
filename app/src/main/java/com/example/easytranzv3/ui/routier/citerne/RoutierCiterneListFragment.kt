 ...
 */
class RoutierCiterneListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                adapter = RoutierCiterneRecyclerViewAdapter(RoutierCiterneDisputesContent.DISPUTES)
            }
    ...
    companion object {
        ...
        fun newInstance(columnCount: Int) =
            RoutierCiterneListFragment().apply {
