...
class TrainIntRecyclerViewAdapter(
    private val values: List<TrainIntDisputesContent.DisputesItem>/*, var mContext: Context*/
) : RecyclerView.Adapter<TrainIntRecyclerViewAdapter.ViewHolder>() {
    ...
    class ViewHolder(view: View, var item: TrainIntDisputesContent.DisputesItem? = null): RecyclerView.ViewHolder(view) {
