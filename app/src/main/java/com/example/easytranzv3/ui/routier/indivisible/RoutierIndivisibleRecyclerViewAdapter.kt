 ...
 */
class RoutierIndivisibleRecyclerViewAdapter(
    private val values: List<RoutierIndivisibleDisputesContent.DisputesItem>/*, var mContext: Context*/
) : RecyclerView.Adapter<RoutierIndivisibleRecyclerViewAdapter.ViewHolder>() {
    ...
    class ViewHolder(view: View, var item: RoutierIndivisibleDisputesContent.DisputesItem? = null): RecyclerView.ViewHolder(view) {
