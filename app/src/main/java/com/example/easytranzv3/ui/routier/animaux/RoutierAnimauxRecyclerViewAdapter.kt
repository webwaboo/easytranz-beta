package com.example.easytranzv3.ui.routier.animaux
 ...
 */
class RoutierAnimauxRecyclerViewAdapter(
    private val values: List<RoutierAnimauxDisputesContent.DisputesItem>/*, var mContext: Context*/
) : RecyclerView.Adapter<RoutierAnimauxRecyclerViewAdapter.ViewHolder>() {
    ...
    class ViewHolder(view: View, var item: RoutierAnimauxDisputesContent.DisputesItem? = null): RecyclerView.ViewHolder(view) {
