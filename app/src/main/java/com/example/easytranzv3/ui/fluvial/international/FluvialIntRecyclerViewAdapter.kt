...
class FluvialIntRecyclerViewAdapter(
    private val values: List<FluvialIntDisputesContent.DisputesItem>/*, var mContext: Context*/
) : RecyclerView.Adapter<FluvialIntRecyclerViewAdapter.ViewHolder>() {
    ...
    class ViewHolder(view: View, var item: FluvialIntDisputesContent.DisputesItem? = null): RecyclerView.ViewHolder(view) {
