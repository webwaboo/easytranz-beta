 ...
 */
class AerienRecyclerViewAdapter(
    private val values: List<AerienDisputesContent.DisputesItem>/*, var mContext: Context*/
) : RecyclerView.Adapter<AerienRecyclerViewAdapter.ViewHolder>() {
    ...
    class ViewHolder(view: View, var item: AerienDisputesContent.DisputesItem? = null): RecyclerView.ViewHolder(view) {
