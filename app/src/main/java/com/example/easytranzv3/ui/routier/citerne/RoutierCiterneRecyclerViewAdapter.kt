 ...
 */
class RoutierCiterneRecyclerViewAdapter(
    private val values: List<RoutierCiterneDisputesContent.DisputesItem>/*, var mContext: Context*/
) : RecyclerView.Adapter<RoutierCiterneRecyclerViewAdapter.ViewHolder>() {
    ...
    class ViewHolder(view: View, var item: RoutierCiterneDisputesContent.DisputesItem? = null): RecyclerView.ViewHolder(view) {
